...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  const ctxErr = global.rcanalx || { contextInfo: { externalAdReply: { title: '❌ Error', body: 'Nino Nakano-IA', thumbnailUrl: 'https://files.catbox.moe/b5f0ev.jpg', sourceUrl: global.canalOficial || '' }}}
  const ctxWarn = global.rcanalw || { contextInfo: { externalAdReply: { title: '⚠️ Advertencia', body: 'Nino Nakano-IA', thumbnailUrl: 'https://files.catbox.moe/b5f0ev.jpg', sourceUrl: global.canalOficial || '' }}}
  const ctxOk = global.rcanalr || { contextInfo: { externalAdReply: { title: '✅ Acción', body: 'Nino Nakano-IA', thumbnailUrl: 'https://qu.ax/QGAVS.jpg', sourceUrl: global.canalOficial || '' }}}
