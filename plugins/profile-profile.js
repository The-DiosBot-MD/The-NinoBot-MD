...
return acc + value }, 0)
const pp = await conn.profilePictureUrl(userId, 'image').catch(_ => 'https://qu.ax/XuhgM.jpg')
const text = `
꒰⌢ ʚ˚₊‧ ✎ ꒱ ❐ PERFIL ❐
> ੭੭ ﹙ᰔᩚ﹚ *${name}*
> .・。.・゜✭・.・✫・゜・。.
...
꒰⌢ ʚ˚₊‧ ✎ ꒱ ❐ INFORMACIÓN ❐
> ੭੭ ﹙ᰔᩚ﹚ ❏ Cumpleaños » *${cumpleanos}*
> ੭੭ ﹙ᰔᩚ﹚ ❏ Género » *${genero}*
> ੭੭ ﹙ᰔᩚ﹚ ❏ Casado con » *${casado}*
> .・。.・゜✭・.・✫・゜・。.

꒰⌢ ʚ˚₊‧ ✎ ꒱ ❐ ESTADÍSTICAS ❐
> ੭੭ ﹙ᰔᩚ﹚ ❏ Experiencia » *${exp.toLocaleString()}*
> ੭੭ ﹙ᰔᩚ﹚ ❏ Nivel » *${nivel}*
> ੭੭ ﹙ᰔᩚ﹚ ❏ Puesto » *#${rank}*
> ੭੭ ﹙ᰔᩚ﹚ ❏ Progreso » *${progreso}*
> ੭੭ ﹙ᰔᩚ﹚ ❏ Premium » ${premium ? `✅️ (*${isLeft}*)` : '❎️'}
> .・。.・゜✭・.・✫・゜・。.

꒰⌢ ʚ˚₊‧ ✎ ꒱ ❐ GACHA ❐
> ੭੭ ﹙ᰔᩚ﹚ ❏ Harem » *${haremCount}*
> ੭੭ ﹙ᰔᩚ﹚ ❏ Valor total » *${haremValue.toLocaleString()}*
${favLine}
> .・。.・゜✭・.・✫・゜・。.

꒰⌢ ʚ˚₊‧ ✎ ꒱ ❐ ECONOMÍA ❐
> ੭੭ ﹙ᰔᩚ﹚ ❏ Coins totales » *${total.toLocaleString()} ${currency}*
> ੭੭ ﹙ᰔᩚ﹚ ❏ Comandos totales » *${user.commands || 0}*
> .・。.・゜✭・.・✫・゜・。.
`.trim()
