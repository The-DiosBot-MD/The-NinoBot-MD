...
const handler = async (m, { conn, text, usedPrefix, command }) => {
  const ctxErr = global.rcanalx || { contextInfo: { externalAdReply: { title: '❌ Error', body: '𝙉𝙄𝙉𝙊-𝙄𝘼', thumbnailUrl: 'https://qu.ax/XuhgM.jpg', sourceUrl: global.canalOficial || '' }}}
  const ctxWarn = global.rcanalw || { contextInfo: { externalAdReply: { title: '𝗤𝘂𝗲 𝗕𝘂𝘀𝗰𝗮𝘀 𝗦𝗲𝗺𝗽𝗮𝗶 🔍✨', body: '𝗡𝗶𝗻𝗼-𝗜𝗔', thumbnailUrl: 'https://qu.ax/XuhgM.jpg', sourceUrl: global.canalOficial || '' }}}
  const ctxOk = global.rcanalr || { contextInfo: { externalAdReply: { title: '✅ 𝗯𝗶𝗲𝗻 𝗯𝗯', body: '𝗡𝗶𝗻𝗼-𝗜𝗔', thumbnailUrl: 'https://qu.ax/XuhgM.jpg', sourceUrl: global.canalOficial || '' }}}
...
handler.command = handler.help = ['play2', 'play3']
